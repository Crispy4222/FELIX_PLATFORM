...
public class MainActivity extends Activity {
    ...
    LinearLayout root, content; TextView state, output, receipt; EditText command, memory, endpoint; DB db; AffectEngine affect; int pad=14;
    ...
    void build(){
        ...
        String[] names={"CONTROL","HEART","GREY","MEMORY","TOOLS","LINK"};
    ...
    static class DB extends SQLiteOpenHelper{
        SQLiteDatabase d; DB(Context c){super(c,"felix.db",null,2);d=getWritableDatabase();}
        ...
        public void onUpgrade(SQLiteDatabase d,int oldV,int newV){if(oldV<2)d.execSQL("CREATE TABLE IF NOT EXISTS affect(emotion TEXT PRIMARY KEY,value REAL,cause TEXT,revision INTEGER,ts INTEGER)");}
